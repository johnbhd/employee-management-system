                ...
                '<div class="flex shrink-0 items-center gap-1.5 sm:gap-2">',
                    ...
                    '<div class="relative">',
                        ...
                        '<div id="profile-menu" class="absolute right-0 top-12 hidden w-56 rounded-2xl border border-slate-200 bg-white p-2 shadow-xl shadow-slate-900/10" data-profile-menu hidden>',
                            ...
                            '</button>',
                            '<a href="../index.html" class="flex w-full items-center gap-2 rounded-xl px-3 py-2.5 text-left text-xs font-semibold text-slate-600 transition hover:bg-slate-50 hover:text-au-navy">',
                                icons.logout,
                                '<span>Logout</span>',
                            '</a>',
                        '</div>',
